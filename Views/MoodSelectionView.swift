...
//  Sona
//
//  Created by Tyler & Alvaro, merged version.
//
    ...
    var body: some View {
        ...
        NavigationStack {
            ...
            .alert(
                ...
                Button("Cancel", role: .cancel) { moodToDelete = nil }
            ...
            // --- FIRESTORE LISTENERS ---
            .onAppear { moodService.listenToUserMoods() }
            .onDisappear { moodService.stopListening() }
        }
    }
